...
feature_flags() {
  ...
  flag_map="${RADIUS_PROXY_ENABLED}:ff-radius-proxy
            ...
            ${LOGSTASH_CHUB_CUSTOMER_PIPELINE_ENABLED}:enable-logstash-chub-sts-patch.yaml
            ${LOGSTASH_CHUB_CUSTOMER_PIPELINE_ENABLED}:enable-logstash-chub-fluentbit-output-patch.yaml"
