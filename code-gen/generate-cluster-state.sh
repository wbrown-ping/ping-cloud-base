...
echo "Initial DISABLE_LOGSTASH_CUSTOMER_PIPELINE: ${DISABLE_LOGSTASH_CUSTOMER_PIPELINE}"
...
export DISABLE_LOGSTASH_CUSTOMER_PIPELINE="${DISABLE_LOGSTASH_CUSTOMER_PIPELINE:-true}"
...
echo "Using DISABLE_LOGSTASH_CUSTOMER_PIPELINE: ${DISABLE_LOGSTASH_CUSTOMER_PIPELINE}"
