...
echo "Initial DASH_REPO_URL: ${DASH_REPO_URL}"

echo "Initial DASH_REPO_BRANCH: ${DASH_REPO_BRANCH}"
...
export DASH_REPO_BRANCH="${DASH_REPO_BRANCH:-v2.3-dev-branch}"
...
echo "Using DASH_REPO_URL: ${DASH_REPO_URL}"

echo "Using DASH_REPO_BRANCH: ${DASH_REPO_BRANCH}"
