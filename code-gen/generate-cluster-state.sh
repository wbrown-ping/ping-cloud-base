...
(
  ...
  if "${IS_BELUGA_ENV}"; then
    ...
    cp -R "${CHUB_TEMPLATES_DIR}/base/ping-cloud/pingcentral" "${K8S_CONFIGS_DIR}/base/ping-cloud/"
    ...
    yq 'del(select(.metadata.name))' "${CHUB_TEMPLATES_DIR}/base/secrets.yaml" >> "${K8S_CONFIGS_DIR}/base/secrets.yaml"
