...
echo "Initial JSON_LOGGING_ENABLED: ${JSON_LOGGING_ENABLED}"
...
export JSON_LOGGING_ENABLED="${JSON_LOGGING_ENABLED:-false}"
...
echo "Using JSON_LOGGING_ENABLED: ${JSON_LOGGING_ENABLED}"
